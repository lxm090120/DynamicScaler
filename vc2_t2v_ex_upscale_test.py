...
class VArgs:
    ...
    merge_renoised_overlap_latent_ratio: float = 0.5
    merge_prev_step: int = 15
...
def main(run_args: RunArgs, prompt, # image_path, image_folder,
    ...
    up_sampled_video_frames, up_sampled_latent = pipeline.basic_sample_shift_multi_windows_with_overlap(
        ...
        init_panorama_latent=renoised_basic_SW_latent,
...
if __name__ == "__main__":
    ...
    prompt = "Soft sakura blossom petals drift slowly in wind, falling onto a lake, creating gentle ripples across the water, surrounded by blooming sakura trees and tranquil, natural beauty"
